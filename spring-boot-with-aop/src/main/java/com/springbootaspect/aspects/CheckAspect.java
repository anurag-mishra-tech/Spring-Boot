package com.springbootaspect.aspects;
...
public class CheckAspect {
  ...
  @Before("@annotation(com.springbootaspect.aspects.CheckSomething)")
  ...
  @AfterReturning(pointcut = "@annotation(com.springbootaspect.aspects.CheckSomething)")
  ...
  @AfterThrowing(pointcut = "@annotation(com.springbootaspect.aspects.CheckSomething)", throwing = "ex")
  ...
  @Around("@annotation(com.springbootaspect.aspects.CheckSomething)")
